...
export default function MusicPlayer() {
    ...
    return (
        <div className="w-96 h-full bg-zinc-300 border-2 border-zinc-400 text-lg rounded-full flex items-center justify-between text-zinc-700 shadow-xl shadow-zinc-500 backdrop-opacity-40">
