  ...
  return (
    <>
          ...
          <div className="w-2/4 py-5 flex flex-col  text-white">
            <div class="max-w-full flex-shrink-0 px-4 text-center lg:mx-0 lg:max-w-3xl lg:pt-8">
              <h1 class="mt-10 text-5xl font-bold tracking-tight text-white sm:text-6xl">
                We built the
                <span class="text-orange-500"> best </span>
                <span class="text-orange-500">PCs</span>
              </h1>
              <div className = "flex flex-col gap-10 items-center justify-start">
              <p class="mt-6 text-lg leading-8 text-gray-300">CHOOSE THE COMPONENTS, WE BUILD IT FOR YOU</p>
                <Link href="/"
                  class="w-fit animate-bounce focus:animate-none hover:animate-none inline-flex text-md font-medium bg-orange-600 mt-3 px-4 py-2 rounded-lg tracking-wide text-white">
                  <span class="ml-2 flex items-center gap-2">Build Now <FaSpaceAwesome /></span>
                </Link>
              </div>
            </div>
          </div>
      ...
      <div className="min-h-screen bg-gradient-to-bl from-black via-zinc-950 to-zinc-800 flex flex-col items-center justify-center  gap-10 py-10">
        <div className="w-11/12 min-h-screen text-orange-700 text-5xl font-bold flex items-ceter justify-end gap-10">
